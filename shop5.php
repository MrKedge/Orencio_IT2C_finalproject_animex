...
echo '<a class="navbar-sm-brand text-light text-decoration-none" >animex@gmail.com.com</a>';
...
echo '<img class="card-img rounded-0 img-fluid" src="assets/img/pic17.png">';
...
echo '<div class="card mb-4 product-wap rounded-0">';
echo '<div class="card rounded-0">';
echo '<img class="card-img rounded-0 img-fluid" src="assets/img/pic18.png">';
echo '<div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">';
echo '<ul class="list-unstyled">';
echo '<li><a class="btn btn-success text-white" href="shop-single.php"><i class="far fa-heart"></i></a></li>';
echo '<li><a class="btn btn-success text-white mt-2" href="shop-single.php"><i class="far fa-eye"></i></a></li>';
...
echo '<div class="card mb-4 product-wap rounded-0">';
echo '<div class="card rounded-0">';
echo '<img class="card-img rounded-0 img-fluid" src="assets/img/pic19.png">';
echo '<div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">';
echo '<ul class="list-unstyled">';
echo '<li><a class="btn btn-success text-white" href="shop-single.php"><i class="far fa-heart"></i></a></li>';
echo '<li><a class="btn btn-success text-white mt-2" href="shop-single.php"><i class="far fa-eye"></i></a></li>';
...
echo '<div class="card mb-4 product-wap rounded-0">';
echo '<div class="card rounded-0">';
echo '<img class="card-img rounded-0 img-fluid" src="assets/img/pic20.png">';
echo '<div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">';
echo '<ul class="list-unstyled">';
echo '<li><a class="btn btn-success text-white" href="shop-single.php"><i class="far fa-heart"></i></a></li>';
echo '<li><a class="btn btn-success text-white mt-2" href="shop-single.php"><i class="far fa-eye"></i></a></li>';
...
echo '<div class="card mb-4 product-wap rounded-0">';
echo '<div class="card rounded-0">';
echo '<img class="card-img rounded-0 img-fluid" src="assets/img/pic21.png">';
echo '<div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">';
echo '<ul class="list-unstyled">';
echo '<li><a class="btn btn-success text-white" href="shop-single.php"><i class="far fa-heart"></i></a></li>';
echo '<li><a class="btn btn-success text-white mt-2" href="shop-single.php"><i class="far fa-eye"></i></a></li>';
...
echo '<div class="card mb-4 product-wap rounded-0">';
echo '<div class="card rounded-0">';
echo '<img class="card-img rounded-0 img-fluid" src="assets/img/pic22.png">';
echo '<div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">';
echo '<ul class="list-unstyled">';
echo '<li><a class="btn btn-success text-white" href="shop-single.php"><i class="far fa-heart"></i></a></li>';
echo '<li><a class="btn btn-success text-white mt-2" href="shop-single.php"><i class="far fa-eye"></i></a></li>';
...
echo '<div class="card mb-4 product-wap rounded-0">';
echo '<div class="card rounded-0">';
echo '<img class="card-img rounded-0 img-fluid" src="assets/img/pic23.png">';
echo '<div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">';
echo '<ul class="list-unstyled">';
echo '<li><a class="btn btn-success text-white" href="shop-single.php"><i class="far fa-heart"></i></a></li>';
echo '<li><a class="btn btn-success text-white mt-2" href="shop-single.php"><i class="far fa-eye"></i></a></li>';
...
echo '<div class="card mb-4 product-wap rounded-0">';
echo '<div class="card rounded-0">';
echo '<img class="card-img rounded-0 img-fluid" src="assets/img/pic24.png">';
echo '<div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">';
echo '<ul class="list-unstyled">';
echo '<li><a class="btn btn-success text-white" href="shop-single.php"><i class="far fa-heart"></i></a></li>';
echo '<li><a class="btn btn-success text-white mt-2" href="shop-single.php"><i class="far fa-eye"></i></a></li>';
...
echo '<div class="card mb-4 product-wap rounded-0">';
echo '<div class="card rounded-0">';
echo '<img class="card-img rounded-0 img-fluid" src="assets/img/pic25.png">';
echo '<div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">';
echo '<ul class="list-unstyled">';
echo '<li><a class="btn btn-success text-white" href="shop-single.php"><i class="far fa-heart"></i></a></li>';
echo '<li><a class="btn btn-success text-white mt-2" href="shop-single.php"><i class="far fa-eye"></i></a></li>';
...
echo '<a class="page-link active rounded-0 mr-3 shadow-sm border-top-0 border-left-0" href="shop5.php">5</a>';
echo '</li>';
echo '<li class="page-item">';
