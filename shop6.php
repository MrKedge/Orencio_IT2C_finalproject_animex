...
echo '<img class="card-img rounded-0 img-fluid" src="assets/img/pic26.png">';
...
echo '<li>';
$item = simplexml_load_file('Orencio_Saludo_IT2C_finalproject_Animex.xml');
echo $item->product[45]->description;
...
echo '<div class="card mb-4 product-wap rounded-0">';
echo '<div class="card rounded-0">';
echo '<img class="card-img rounded-0 img-fluid" src="assets/img/pic27.png">';
echo '<div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">';
echo '<ul class="list-unstyled">';
echo '<li><a class="btn btn-success text-white" href="shop-single.php"><i class="far fa-heart"></i></a></li>';
echo '<li><a class="btn btn-success text-white mt-2" href="shop-single.php"><i class="far fa-eye"></i></a></li>';
...
echo '<li>';
$item = simplexml_load_file('Orencio_Saludo_IT2C_finalproject_Animex.xml');
echo $item->product[46]->description;
...
echo '<div class="card mb-4 product-wap rounded-0">';
echo '<div class="card rounded-0">';
echo '<img class="card-img rounded-0 img-fluid" src="assets/img/pic28.png">';
echo '<div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">';
echo '<ul class="list-unstyled">';
echo '<li><a class="btn btn-success text-white" href="shop-single.php"><i class="far fa-heart"></i></a></li>';
echo '<li><a class="btn btn-success text-white mt-2" href="shop-single.php"><i class="far fa-eye"></i></a></li>';
...
echo '<li>';
$item = simplexml_load_file('Orencio_Saludo_IT2C_finalproject_Animex.xml');
echo $item->product[47]->description;
...
echo '<div class="card mb-4 product-wap rounded-0">';
echo '<div class="card rounded-0">';
echo '<img class="card-img rounded-0 img-fluid" src="assets/img/pic29.png">';
echo '<div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">';
echo '<ul class="list-unstyled">';
echo '<li><a class="btn btn-success text-white" href="shop-single.php"><i class="far fa-heart"></i></a></li>';
echo '<li><a class="btn btn-success text-white mt-2" href="shop-single.php"><i class="far fa-eye"></i></a></li>';
...
echo '<li>';
$item = simplexml_load_file('Orencio_Saludo_IT2C_finalproject_Animex.xml');
echo $item->product[48]->description;
...
echo '<li>';
$item = simplexml_load_file('Orencio_Saludo_IT2C_finalproject_Animex.xml');
echo $item->product[49]->description;
...
echo '<li>';
$item = simplexml_load_file('Orencio_Saludo_IT2C_finalproject_Animex.xml');
echo $item->product[50]->description;
...
echo '<li>';
$item = simplexml_load_file('Orencio_Saludo_IT2C_finalproject_Animex.xml');
echo $item->product[51]->description;
...
echo '<li>';
$item = simplexml_load_file('Orencio_Saludo_IT2C_finalproject_Animex.xml');
echo $item->product[52]->description;
...
echo '<li>';
$item = simplexml_load_file('Orencio_Saludo_IT2C_finalproject_Animex.xml');
echo $item->product[53]->description;
...
echo '<a class="page-link active rounded-0 mr-3 shadow-sm border-top-0 border-left-0" href="shop6.php">6</a>';
echo '</li>';
echo '<li class="page-item">';
