...
echo '<img class="card-img rounded-0 img-fluid" src="assets/img/anime19.png">';
...
echo '</div>';
                                ...
                                echo '<li>';
                                $item = simplexml_load_file('Orencio_Saludo_IT2C_finalproject_Animex.xml');
                                echo $item->product[18]->description;
...
echo '<div class="card mb-4 product-wap rounded-0">';
echo '<div class="card rounded-0">';
echo '<img class="card-img rounded-0 img-fluid" src="assets/img/anime20.png">';
echo '<div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">';
echo '<ul class="list-unstyled">';
echo '<li><a class="btn btn-success text-white" href="shop-single.php"><i class="far fa-heart"></i></a></li>';
echo '<li><a class="btn btn-success text-white mt-2" href="shop-single.php"><i class="far fa-eye"></i></a></li>';
...
echo '</div>';
                                ...
                                echo '<li>';
                                $item = simplexml_load_file('Orencio_Saludo_IT2C_finalproject_Animex.xml');
                                echo $item->product[19]->description;
...
echo '<div class="card mb-4 product-wap rounded-0">';
echo '<div class="card rounded-0">';
echo '<img class="card-img rounded-0 img-fluid" src="assets/img/anime21.png">';
echo '<div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">';
echo '<ul class="list-unstyled">';
echo '<li><a class="btn btn-success text-white" href="shop-single.php"><i class="far fa-heart"></i></a></li>';
echo '<li><a class="btn btn-success text-white mt-2" href="shop-single.php"><i class="far fa-eye"></i></a></li>';
...
echo '</div>';
                                ...
                                echo '<li>';
                                $item = simplexml_load_file('Orencio_Saludo_IT2C_finalproject_Animex.xml');
                                echo $item->product[20]->description;
...
echo '<div class="card mb-4 product-wap rounded-0">';
echo '<div class="card rounded-0">';
echo '<img class="card-img rounded-0 img-fluid" src="assets/img/anime22.png">';
echo '<div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">';
echo '<ul class="list-unstyled">';
echo '<li><a class="btn btn-success text-white" href="shop-single.php"><i class="far fa-heart"></i></a></li>';
echo '<li><a class="btn btn-success text-white mt-2" href="shop-single.php"><i class="far fa-eye"></i></a></li>';
...
echo '</div>';
                                ...
                                echo '<li>';
                                $item = simplexml_load_file('Orencio_Saludo_IT2C_finalproject_Animex.xml');
                                echo $item->product[21]->description;
...
echo '<div class="card mb-4 product-wap rounded-0">';
echo '<div class="card rounded-0">';
echo '<img class="card-img rounded-0 img-fluid" src="assets/img/pic1.png">';
echo '<div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">';
echo '<ul class="list-unstyled">';
echo '<li><a class="btn btn-success text-white" href="shop-single.php"><i class="far fa-heart"></i></a></li>';
echo '<li><a class="btn btn-success text-white mt-2" href="shop-single.php"><i class="far fa-eye"></i></a></li>';
...
echo '</div>';
                            ...
                            echo '<li>';
                            $item = simplexml_load_file('Orencio_Saludo_IT2C_finalproject_Animex.xml');
                            echo $item->product[22]->description;
...
echo '<div class="card mb-4 product-wap rounded-0">';
echo '<div class="card rounded-0">';
echo '<img class="card-img rounded-0 img-fluid" src="assets/img/pic2.png">';
echo '<div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">';
echo '<ul class="list-unstyled">';
echo '<li><a class="btn btn-success text-white" href="shop-single.php"><i class="far fa-heart"></i></a></li>';
echo '<li><a class="btn btn-success text-white mt-2" href="shop-single.php"><i class="far fa-eye"></i></a></li>';
...
echo '</div>';
                                ...
                                echo '<li>';
                                $item = simplexml_load_file('Orencio_Saludo_IT2C_finalproject_Animex.xml');
                                echo $item->product[23]->description;
...
echo '<div class="card mb-4 product-wap rounded-0">';
echo '<div class="card rounded-0">';
echo '<img class="card-img rounded-0 img-fluid" src="assets/img/pic3.png">';
echo '<div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">';
echo '<ul class="list-unstyled">';
echo '<li><a class="btn btn-success text-white" href="shop-single.php"><i class="far fa-heart"></i></a></li>';
echo '<li><a class="btn btn-success text-white mt-2" href="shop-single.php"><i class="far fa-eye"></i></a></li>';
...
echo '</div>';
                                    ...
                                    echo '<li>';
                                    $item = simplexml_load_file('Orencio_Saludo_IT2C_finalproject_Animex.xml');
                                    echo $item->product[24]->description;
...
echo '<div class="card mb-4 product-wap rounded-0">';
echo '<div class="card rounded-0">';
echo '<img class="card-img rounded-0 img-fluid" src="assets/img/pic4.png">';
echo '<div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">';
echo '<ul class="list-unstyled">';
echo '<li><a class="btn btn-success text-white" href="shop-single.php"><i class="far fa-heart"></i></a></li>';
echo '<li><a class="btn btn-success text-white mt-2" href="shop-single.php"><i class="far fa-eye"></i></a></li>';
...
echo '<li>';
$item = simplexml_load_file('Orencio_Saludo_IT2C_finalproject_Animex.xml');
echo $item->product[25]->description;
...
echo '<div class="card mb-4 product-wap rounded-0">';
echo '<div class="card rounded-0">';
echo '<img class="card-img rounded-0 img-fluid" src="assets/img/pic5.png">';
echo '<div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">';
echo '<ul class="list-unstyled">';
echo '<li><a class="btn btn-success text-white" href="shop-single.php"><i class="far fa-heart"></i></a></li>';
echo '<li><a class="btn btn-success text-white mt-2" href="shop-single.php"><i class="far fa-eye"></i></a></li>';
...
echo '<li>';
$item = simplexml_load_file('Orencio_Saludo_IT2C_finalproject_Animex.xml');
echo $item->product[26]->description;
...
echo '<a class="page-link active rounded-0 mr-3 shadow-sm border-top-0 border-left-0" href="shop3.php">3</a>';
echo '</li>';
echo '<li class="page-item">';
echo '<a class="page-link rounded-0 mr-3 shadow-sm border-top-0 border-left-0 text-dark" href="shop4.php">4</a>';
echo '</li>';
echo '<li class="page-item">';
echo '<a class="page-link rounded-0 shadow-sm border-top-0 border-left-0 text-dark" href="#">5</a>';
echo '</li>';
echo '<li class="page-item">';
echo '<a class="page-link rounded-0 shadow-sm border-top-0 border-left-0 text-dark" href="#">6</a>';
echo '</li>';
echo '<li class="page-item">';
echo '<a class="page-link rounded-0 shadow-sm border-top-0 border-left-0 text-dark" href="#">7</a>';
echo '</li>';
echo '<li class="page-item">';
